...
| Dashboard creation | data-viz-engineer | sonnet |
| Incident response | incident-commander | sonnet |
...
- **Don't use `console.log`** — Always use structured logging with correlation IDs and Solana context.
